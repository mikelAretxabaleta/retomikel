...
DROP
 ...
 --creacion y restricción de tablas 
  ...
  TABLE AVISOS
  (
    ID        NUMBER (7) CONSTRAINT AVISOS_PK PRIMARY KEY,
...
CREATE
  TABLE VEHICULOS
  (
    ID        NUMBER (7) CONSTRAINT VEHICULOS_PK PRIMARY KEY ,
    marca     VARCHAR2 (50) NOT NULL,
    modelo    VARCHAR2 (50) NOT NULL,
    matricula VARCHAR2 (15) NOT NULL
	TRABAJADORES_ID   NUMBER (7) NOT NULL,
	fecha             DATE ,
	CONSTRAINT VHC_TRF_FK FOREIGN KEY (TRABAJADORES_ID, FECHA) REFERENCES PARTES (TRABAJADORES_ID, FECHA)
  ) ;
...
--secuencias creciacion
CREATE SEQUENCE  "LOGISTICA"."SQAVISOS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOCYCLE;
CREATE SEQUENCE  "LOGISTICA"."SQCENTROS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOCYCLE;
CREATE SEQUENCE  "LOGISTICA"."SQTRABAJADORES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOCYCLE ;
CREATE SEQUENCE  "LOGISTICA"."SQVEHICULOS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOCYCLE ;
CREATE SEQUENCE  "LOGISTICA"."SQVIAJES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOCYCLE;